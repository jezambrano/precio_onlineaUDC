                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="/"><span class="glyphicon glyphicon-home" aria-hidden="true"></span> Inicio</a></li>
                           ...
                           <li class="dropdown">
                            <a href="comercio" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Presentacion <span class="caret"></span></a>
                            <ul class="dropdown-menu">
                                <li><a href="{{ route('presentacion.index') }}">Ver Todos</a></li>
                                <li><a href="{{ route('presentacion.create') }}"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Nueva</a></li>
                            </ul>
                        </li>
